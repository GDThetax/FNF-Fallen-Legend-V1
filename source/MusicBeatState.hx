...
class MusicBeatState extends FlxUIState
{
	...
	public static function switchState(nextState:FlxState, ?resetFreeplau:Bool = true) {
	...
	private function staticTransition() {
		
	}

	public static function resetState() {
		MusicBeatState.switchState(FlxG.state, false);
	}
