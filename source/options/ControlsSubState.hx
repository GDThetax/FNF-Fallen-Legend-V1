...
class ControlsSubState extends MusicBeatSubstate {
	...
	public function new() {
		...
		var returnTXT:FlxText = new FlxText(0, 0, 0, "	<-- Press ESC to return to options menu");
		returnTXT.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, LEFT);
		returnTXT.scrollFactor.set(1, 1);
		add(returnTXT);
	}
