...
class WeekData {
	...
	public var actImage:String;
	public var actName:String;
	public var actMessage:String;
	...
	public static function createWeekFile():WeekFile {
		var weekFile:WeekFile = {
			...
			hideFreeplay: false,
			difficulties: '',
			actImage: "Act-1-StoryImage",
			actName: "placeholder",
			actMessage: "placeholder"
		};
		return weekFile;
	}
	...
	public function new(weekFile:WeekFile, fileName:String) {
		...
		actImage = weekFile.actImage;
		actName = weekFile.actName;
		actMessage = weekFile.actMessage;
